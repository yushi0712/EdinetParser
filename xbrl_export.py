...
summary_column = ["EDINETコード", "提出者名", "証券コード", "業種", "年度", "会計基準",\
                  "従業員数", "純資産", "総資産", "売上高", "純利益", "株価収益率", "営業CF", "投資CF", "財務CF", "現金",\
                  "従業員数(P1Y)", "純資産(P1Y)", "総資産(P1Y)", "売上高(P1Y)", "純利益(P1Y)", "株価収益率(P1Y)", "営業CF(P1Y)", "投資CF(P1Y)", "財務CF(P1Y)", "現金(P1Y)",\
                  "従業員数(P2Y)", "純資産(P2Y)", "総資産(P2Y)", "売上高(P2Y)", "純利益(P2Y)", "株価収益率(P2Y)", "営業CF(P2Y)", "投資CF(P2Y)", "財務CF(P2Y)", "現金(P2Y)",\
                  "従業員数(P3Y)", "純資産(P3Y)", "総資産(P3Y)", "売上高(P3Y)", "純利益(P3Y)", "株価収益率(P3Y)", "営業CF(P3Y)", "投資CF(P3Y)", "財務CF(P3Y)", "現金(P3Y)",\
                  "従業員数(P4Y)", "純資産(P4Y)", "総資産(P4Y)", "売上高(P4Y)", "純利益(P4Y)", "株価収益率(P4Y)", "営業CF(P4Y)", "投資CF(P4Y)", "財務CF(P4Y)", "現金(P4Y)"]
...
for index, row in df_xbrl_contents.iterrows():
    ...
    if path.isfile(xbrl_path):
        ...
        if (row["年度"]==2017):
            ...
            s_asr["純資産"] = _get_tag_val(df_xbrl_data, [["EquityAttributableToOwnersOfParentIFRSSummaryOfBusinessResults",CYI], ["EquityIncludingPortionAttributableToNonControllingInterestUSGAAPSummaryOfBusinessResults",CYI], ["EquityAttributableToOwnersOfParentUSGAAPSummaryOfBusinessResults",CYI], ["NetAssetsSummaryOfBusinessResults",CYI], ["NetAssets",CYI], ["NetAssets",CYI_NCM], ["NetAssetsSummaryOfBusinessResults",CYI_NCM]])
            ...
            s_asr["純資産(P1Y)"] = _get_tag_val(df_xbrl_data, [["EquityAttributableToOwnersOfParentIFRSSummaryOfBusinessResults",P1I], ["EquityIncludingPortionAttributableToNonControllingInterestUSGAAPSummaryOfBusinessResults",P1I], ["EquityAttributableToOwnersOfParentUSGAAPSummaryOfBusinessResults",P1I], ["NetAssetsSummaryOfBusinessResults",P1I], ["NetAssets",P1I], ["NetAssets",P1I_NCM], ["NetAssetsSummaryOfBusinessResults",P1I_NCM]])
            ...
            s_asr["純資産(P2Y)"] = _get_tag_val(df_xbrl_data, [["EquityAttributableToOwnersOfParentIFRSSummaryOfBusinessResults",P2I], ["EquityIncludingPortionAttributableToNonControllingInterestUSGAAPSummaryOfBusinessResults",P2I], ["EquityAttributableToOwnersOfParentUSGAAPSummaryOfBusinessResults",P2I], ["NetAssetsSummaryOfBusinessResults",P2I], ["NetAssets",P2I], ["NetAssets",P2I_NCM], ["NetAssetsSummaryOfBusinessResults",P2I_NCM]])
            ...
            s_asr["純資産(P3Y)"] = _get_tag_val(df_xbrl_data, [["EquityAttributableToOwnersOfParentIFRSSummaryOfBusinessResults",P3I], ["EquityIncludingPortionAttributableToNonControllingInterestUSGAAPSummaryOfBusinessResults",P3I], ["EquityAttributableToOwnersOfParentUSGAAPSummaryOfBusinessResults",P3I], ["NetAssetsSummaryOfBusinessResults",P3I], ["NetAssets",P3I], ["NetAssets",P3I_NCM], ["NetAssetsSummaryOfBusinessResults",P3I_NCM]])
            ...
            s_asr["純資産(P4Y)"] = _get_tag_val(df_xbrl_data, [["EquityAttributableToOwnersOfParentIFRSSummaryOfBusinessResults",P4I], ["EquityIncludingPortionAttributableToNonControllingInterestUSGAAPSummaryOfBusinessResults",P4I], ["EquityAttributableToOwnersOfParentUSGAAPSummaryOfBusinessResults",P4I], ["NetAssetsSummaryOfBusinessResults",P4I], ["NetAssets",P4I], ["NetAssets",P4I_NCM], ["NetAssetsSummaryOfBusinessResults",P4I_NCM]])

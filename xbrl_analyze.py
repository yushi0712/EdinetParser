...
summary_column = ["EDINETコード", "提出者名", "証券コード", "業種", "年度", "会計基準",\
                  "従業員数", "総資産", "売上高", "純利益", "営業CF", "投資CF", "財務CF", "現金",\
                  "従業員数(P1Y)", "総資産(P1Y)", "売上高(P1Y)", "純利益(P1Y)", "営業CF(P1Y)", "投資CF(P1Y)", "財務CF(P1Y)", "現金(P1Y)",\
                  "従業員数(P2Y)", "総資産(P2Y)", "売上高(P2Y)", "純利益(P2Y)", "営業CF(P2Y)", "投資CF(P2Y)", "財務CF(P2Y)", "現金(P2Y)",\
                  "従業員数(P3Y)", "総資産(P3Y)", "売上高(P3Y)", "純利益(P3Y)", "営業CF(P3Y)", "投資CF(P3Y)", "財務CF(P3Y)", "現金(P3Y)",\
                  "従業員数(P4Y)", "総資産(P4Y)", "売上高(P4Y)", "純利益(P4Y)", "営業CF(P4Y)", "投資CF(P4Y)", "財務CF(P4Y)", "現金(P4Y)"]
